...
namespace Sounds_Packing.Classes
{
    class Folder
    {
        ...
        // Folder Class Default Constractor
        public Folder()
        {
            Name = "";
            Path = "";
        ...
        // Set Folder Name
        public void Set_Name(string Folder_Name) => Name = Folder_Name;


        // Set Folder Duration
        public void Set_Duration(int Folder_Duration) => Duration = Folder_Duration;


        // Set Folder Free Space
        public void Set_FreeSpace(int Folder_FreeSpace) => FreeSpace = Folder_FreeSpace;


        // Set Folder List Of Sounds
        public void Add_Sound(Sound_File Sound) => Sounds.Add(Sound);
